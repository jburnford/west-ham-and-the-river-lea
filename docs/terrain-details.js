...
export function terrainDetails({THREE,scene,materials:m,data,box,cylinder,beam,random}) {
  ...
  let clodCount=0;
  for(let attempt=0;attempt<145000;attempt++) {
  ...
  for(let attempt=0;attempt<36000;attempt++) {
